...
- model outputs can be sensitive to prompt wording and candidate-answer formatting

## License

The repository source code is released under the [Apache License 2.0](../LICENSE). Check the [Hugging Face model page](https://huggingface.co/cccmmmzzz/metis-brain-signal-foundation-model) for checkpoint metadata.
