...
| Model | Modality | Layers | Hidden Size | MoE | Intended Use | Status |
|---|---|---:|---:|---|---|---|
| METIS-Base | EEG + iEEG | 12 | 512 | 8 routed experts + 1 shared expert | Zero-shot Signal-QA, few-shot linear probing, cross-dataset transfer | Planned |
| METIS-Encoder | EEG + iEEG | 12 | 512 | Same backbone | Feature extraction for downstream classifiers | Planned |
